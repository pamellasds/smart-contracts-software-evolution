...
contract synth is externstatetoken {
    ...
    function _transfertofeeaddress(address to, uint value) internal returns (bool) {
        ...
        if (currencykey == ) {
            ...
            isynthetix(synthetixproxy).synthinitiatedexchange(messagesender, currencykey, value, , fee_address);
            amountinusd = isynthetix(synthetixproxy).effectivevalue(currencykey, value, );
        }
