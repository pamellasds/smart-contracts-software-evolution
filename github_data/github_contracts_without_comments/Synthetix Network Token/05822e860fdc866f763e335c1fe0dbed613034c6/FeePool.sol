...
contract feepool is proxyable, selfdestructible, limitedsetup {
        ...
        optionalproxy_onlyowner
    {
        ...
        for (uint i = 0; i < fee_period_length; i++) {
            uint feestodistribute = synthetix.effectivevalue(, _recentfeeperiodsstorage(i).feestodistribute, susd);
            uint feesclaimed = synthetix.effectivevalue(, _recentfeeperiodsstorage(i).feesclaimed, susd);
