...
contract synthetix is externstatetoken, mixinresolver {
    ...
    function ethercollateral() internal view returns (iethercollateral) {
        require(resolver.getaddress() != address(0), );
        return iethercollateral(resolver.getaddress());
    }
    ...
    function supplyschedule() internal view returns (supplyschedule) {
        require(resolver.getaddress() != address(0), );
        return supplyschedule(resolver.getaddress());
    }
    ...
    function rewardsdistribution() internal view returns (irewardsdistribution) {
        require(resolver.getaddress() != address(0), );
        return irewardsdistribution(resolver.getaddress());
    }
        ...
        )
    {
        ...
        uint destinationvalue = effectivevalue(, collateral(_issuer), susd);
