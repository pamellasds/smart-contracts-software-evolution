...
contract guy {
    ...
    function can_frob(address pit, bytes32 ilk, bytes32 u, bytes32 v, bytes32 w, int dink, int dart) public returns (bool) {
        ...
        bytes memory can_call = abi.encodewithsignature(, pit, data);
...
contract frobtest is dstest {
    ...
    function test_alt_callers() public {
        ...
        ali.frob(address(pit), , a, a, a, 10 ether, 5 ether);

        
        asserttrue( ali.can_frob(address(pit), , a, a, a,  1 ether,  0 ether));
        asserttrue( bob.can_frob(address(pit), , a, b, b,  1 ether,  0 ether));
        asserttrue( che.can_frob(address(pit), , a, c, c,  1 ether,  0 ether));
        
        asserttrue(!ali.can_frob(address(pit), , a, b, a,  1 ether,  0 ether));
        asserttrue(!bob.can_frob(address(pit), , a, c, b,  1 ether,  0 ether));
        asserttrue(!che.can_frob(address(pit), , a, a, c,  1 ether,  0 ether));
        ...
        asserttrue( ali.can_frob(address(pit), , a, b, a, 1 ether,  0 ether));
        asserttrue( ali.can_frob(address(pit), , a, c, a, 1 ether,  0 ether));

        
        asserttrue( ali.can_frob(address(pit), , a, a, a,  0 ether,  1 ether));
        asserttrue(!bob.can_frob(address(pit), , a, b, b,  0 ether,  1 ether));
        asserttrue(!che.can_frob(address(pit), , a, c, c,  0 ether,  1 ether));
        
        asserttrue( ali.can_frob(address(pit), , a, a, b,  0 ether,  1 ether));
        asserttrue( ali.can_frob(address(pit), , a, a, c,  0 ether,  1 ether));
        ...
        asserttrue(!ali.can_frob(address(pit), , a, a, b,  0 ether, 1 ether));
        asserttrue(!bob.can_frob(address(pit), , a, b, c,  0 ether, 1 ether));
        asserttrue(!che.can_frob(address(pit), , a, c, a,  0 ether, 1 ether));
    }
}
